...
const Reception = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (editingId) {
      ...
      // Create new repair
      const selectedVehicle = mockVehicles.find(v => v.id.toString() === formData.vehicleId);
      const newRepair = {
        id: `R-${Date.now()}`,
        vehicleId: formData.vehicleId,
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="mb-2">
        <h1 className="text-2xl font-bold">Tiếp nhận xe</h1>
      </div>
                ...
                return (
                  <tr key={repair.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div>{repair.licensePlate || vehicle.licensePlate}</div>
                      <div className="text-gray-400 text-xs">{repair.owner || vehicle.owner}</div>
                    </td>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl">
            <div className="p-6">
              <h2 className="text-xl font-bold mb-4">
                {editingId ? 'Cập nhật phiếu tiếp nhận' : 'Tạo phiếu tiếp nhận mới'}
              </h2>
